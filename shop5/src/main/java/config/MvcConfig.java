...
@ComponentScan(basePackages= {"controller", "logic", "dao", "aop", "websocket"})  //@Componenet 형태 모두 객체화시킬 것
@EnableAspectJAutoProxy   //aop 설정
@EnableWebMvc   //유효성 검증을 위한 어노테이션 처리
public class MvcConfig implements WebMvcConfigurer{
	...
	public MultipartResolver multipartResolver() {   //파일 업로드 설정
		...
		mr.setMaxInMemorySize(10485760);   //10M까지 메모리에 저장. 그 이상은 임시파일로 저장
