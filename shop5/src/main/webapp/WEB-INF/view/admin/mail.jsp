...
<form name="mailform" method="post" action="mail.shop" enctype="multipart/form-data" onsubmit="return idinputchk(this)">
  ...
  <table>
  	...
  	<%-- 홍길동 <hong@aaa.bbb>,김삿갓 <kimsg@aaa.bbb>, --%>
  	<tr><td>받는 사람</td><td><input type="text" name="recipient" size="100" value=
  	...
  	<tr><td>메세지형식</td><td><select name="mtype">
  						...
  						<option value="text/plain; charset=utf-8">TEXT</option></select></td></tr>    <%-- mime 마임 타입 --%>
  	...
  	<tr><td colspan="2">
  		...
  		<script>CKEDITOR.replace("contents")</script></td></tr>   <%-- layout.jsp 에서 설정되어있음 --%>
