...
<body>
<h2>상품 상세 보기</h2>
<%-- http://localhost:8080/shop3/item/detail.shop?id=1 
	http://localhost:8080/shop3/item/img/이미지파일 -> 이 형태로는 가져올 수 없음.
	webapp 가 루트이기 때문에, webapp 아래에 item 폴더 안에 img 파일이 있어야 함
--%>
<table>
